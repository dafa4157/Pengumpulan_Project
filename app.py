...
if not df.empty:
    ...
    st.write(f"**Nama Project:** {safe_str(df.at[selected_index, 'Nama Project'])}")
    st.write(f"**Status:** {safe_str(df.at[selected_index, 'Status'])}")
    st.write(f"**Tanggal Upload Pertama:** {safe_str(df.at[selected_index, 'Tanggal Upload Pertama'])}")
    st.write(f"**Tanggal Update Terakhir:** {safe_str(df.at[selected_index, 'Tanggal Update Terakhir'])}")
    st.write(f"**Tanggal Selesai:** {safe_str(df.at[selected_index, 'Tanggal Selesai'])}")
