...
if not df.empty:
    ...
    if uploaded_files:
        ...
        # Ambil file yang sudah ada di folder uploads supaya up-to-date
        ...
        if files_to_upload:
            ...
            st.experimental_rerun()  # reload supaya perubahan langsung terlihat
    ...
    if df.at[selected_index, 'Selesai']:
        ...
        if df.at[selected_index, 'Tanggal Upload Pertama'] in [None, 'None', 'nan'] or pd.isna(df.at[selected_index, 'Tanggal Upload Pertama']):
            ...
            if selesai_checkbox:
                ...
                st.experimental_rerun()  # reload supaya checkbox langsung berubah
